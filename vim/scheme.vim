" Vim syntax file
" Language: Scheme (R7RS and CHICKEN extensions)
...
setl iskeyword=33,35-39,42-58,60-90,94,95,97-122,126
...
syn region schemeQuote matchgroup=schemeData start=/'['`]*|/ skip=/\\[\\|]/ end=/|/
syn region schemeQuote matchgroup=schemeData start=/'['`]*#\?(/ end=/)/ contains=ALLBUT,schemeQuasiquote,schemeQuasiquoteForm,schemeUnquote,schemeForm,schemeSyntax,schemeFunction,schemeKeyword,schemeExtraSyntax,schemeSyntaxSyntax,schemeTypeSyntax,schemeDatumCommentForm

syn region schemeQuasiquote matchgroup=schemeData start=/`['`]*/ end=/[ \t\n()\[\]";]/me=e-1
syn region schemeQuasiquote matchgroup=schemeData start=/`['`]*#\?(/ end=/)/ contains=ALLBUT,schemeQuote,schemeQuoteForm,schemeForm,schemeSyntax,schemeFunction,schemeKeyword,schemeExtraSyntax,schemeSyntaxSyntax,schemeTypeSyntax,schemeDatumCommentForm

syn region schemeUnquote matchgroup=schemeParentheses start=/,/ end=/[ `'\t\n\[\]()";]/me=e-1 contained contains=ALLBUT,schemeDatumCommentForm
syn region schemeUnquote matchgroup=schemeParentheses start=/,@/ end=/[ `'\t\n\[\]()";]/me=e-1 contained contains=ALLBUT,schemeDatumCommentForm
syn region schemeUnquote matchgroup=schemeParentheses start=/,(/ end=/)/ contained contains=ALLBUT,schemeDatumCommentForm
syn region schemeUnquote matchgroup=schemeParentheses start=/,@(/ end=/)/ contained contains=ALLBUT,schemeDatumCommentForm

syn region schemeQuoteForm matchgroup=schemeData start=/(/ end=/)/ contained contains=ALLBUT,schemeQuasiquote,schemeQuasiquoteForm,schemeUnquote,schemeForm,schemeSyntax,schemeFunction,schemeKeyword,schemeExtraSyntax,schemeSyntaxSyntax,schemeTypeSyntax,schemeDatumCommentForm
syn region schemeQuasiquoteForm matchgroup=schemeData start=/(/ end=/)/ contained contains=ALLBUT,schemeQuote,schemeForm,schemeSyntax,schemeFunction,schemeKeyword,schemeExtraSyntax,schemeSyntaxSyntax,schemeTypeSyntax,schemeDatumCommentForm

syn match schemeIdentifier /[a-zA-Z0-9!$%&*+\-\./:<=>?@^_~#]\+/

syn region schemeString start=/\(\\\)\@<!"/ skip=/\\[\\"]/ end=/"/
syn region schemeSymbol start=/\(\\\)\@<!|/ skip=/\\[\\|]/ end=/|/

syn match schemeNumber /\(#[dbeiox]\)*[+\-]*\([0-9]\|inf.0\|nan.0\)[0-9a-fA-F+\-@\.ilns]*/
...
syn region schemeForm matchgroup=schemeParentheses start="(" end=")" contains=ALLBUT,schemeUnquote,schemeDatumCommentForm
syn region schemeForm matchgroup=schemeParentheses start="\[" end="\]" contains=ALLBUT,schemeUnquote,schemeDatumCommentForm

syn region schemeVector matchgroup=schemeData start="#(" end=")" contains=ALLBUT,schemeQuasiquote,schemeQuasiquoteForm,schemeUnquote,schemeForm,schemeSyntax,schemeFunction,schemeKeyword,schemeExtraSyntax,schemeSyntaxSyntax,schemeTypeSyntax,schemeDatumCommentForm
syn region schemeVector matchgroup=schemeData start="#[fsu]\d\+(" end=")" contains=schemeNumber,schemeError
...
syn keyword schemeLibrarySyntax prefix
syn keyword schemeLibrarySyntax rename
syn keyword schemeLibrarySyntax srfi
